...
import { TransactionType } from "../types/TransactionsTypes/TransactionType.js";
...
const TransactionController = {
   ...
   async getByDatePaid(req: Request, res: Response, next: NextFunction) {
      try {
         const { date } = req.body
   ...
   async create(req: Request, res: Response, next: NextFunction) {
      try {
         ...
         appointmentsId.forEach(async(id : number) => {
   ...
   async getByUserId(req: Request, res: Response, next: NextFunction) {
      ...
      let transactionsIdList :number[] = appointmentsList.reduce((acc, element) => {
      ...
      let transactionsList = transactionsIdList.map((id) => {
         ...
         let transactionToAdd: TransactionType = {
            id: id,
